...
PackageManager.showPackages = function(params) {
  ...
  console.log(chalk.green.bold("Packages has been Installed: "));
  console.log(str);
}
PackageManager.remove = function(params) {
  ...
  for (var i = tmpTrees.length - 1; i >= 0; i--) {
    ...
    if (tarmd5 == orgmd5) {
      console.log(chalk.green.bold(tmpTrees[i]) + " no modify.")
    } else {
  ...
  console.log(chalk.green.bold("Compare Complate!"));
