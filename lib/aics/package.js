...
var uploadZip = function(obj) {
    console.log('===============step 3===============', obj.zipPath);
    var options = {
      method: 'POST',
    ...
    var req = rp(options);
    var form = req.form();
    console.log(obj.config.targetId);
    ...
    // var r = request.post(, function(err, httpResponse, body) {
    //     var body = JSON.parse(body);
    //     var msg = (body.code > 0) ? "发布成功" : '发布失败'
    //     console.log(msg);
    // })
