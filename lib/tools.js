...
Tools.confRemove = function(name) {
  ...
  fs.writeFileSync(path.resolve(".aics/packages.json"), JSON.stringify(packageConf, null, 4));
  fs.writeFileSync(path.resolve(".aics/project.json"), JSON.stringify(projConf, null, 4));
}
