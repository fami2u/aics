...
ProjectManager.init = function(args) {
    ...
    if (args.length < 5) {
        ...
        console.log("init  --package  packageName                      将当前目录初始化为AICS package项目");
        console.log("init  --project  projectName                      将当前目录初始化为AICS project项目");
        console.log("init  --project --example username:projectName    根据项目模版创建项目");
        return;
    }
    var type = args[3];
